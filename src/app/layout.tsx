  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,600;0,700;1,400;1,600&family=Playfair+Display:wght@700;900&family=Jost:wght@400;500;600;700&display=swap" rel="stylesheet" />
        <script
