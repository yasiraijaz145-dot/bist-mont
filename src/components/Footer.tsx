    ...
    <footer className="site-footer">
      <div className="footer-grid">
        ...
        <div className="footer-col">
          <h4>Quick Links</h4>
          <ul>
            {([['Home','/'],['Menu','/menu'],['About','/about'],['Reservations','/reservations'],['Contact','/contact'],['Track Order','/track']] as [string,string][]).map(([label, href]) => (
        ...
        <div className="footer-col">
          ...
          <div style={{ marginTop: '16px', fontSize: '13px', color: 'rgba(255,255,255,0.5)', lineHeight: '1.8' }}>
            ...
            📞 <a href="tel:+15145550192" style={{ color: 'inherit', textDecoration: 'none' }}>+1 (514) 555-0192</a>
          </div>
        </div>
