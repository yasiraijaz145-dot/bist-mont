  ...
  return (
    <>
      ...
      <main style={{ paddingTop: '110px', background: '#fff' }}>
        ...
        {/* Hero */}
        <section style={{ background: '#1a1a1a', padding: '100px 40px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative' }}>
            <p style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '3px', textTransform: 'uppercase', color: '#e85d04', marginBottom: '20px' }}>Give the Gift of Fine Dining</p>
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(2.5rem, 6vw, 5rem)', fontWeight: 700, color: '#fff', lineHeight: 1.05, marginBottom: '20px' }}>
              A meal worth<br />
              <em style={{ color: '#e85d04' }}>remembering.</em>
            </h1>
        ...
        <section style={{ maxWidth: '800px', margin: '0 auto', padding: '100px 40px' }}>
          ...
          <div style={{
            ...
            <div style={{ position: 'relative' }}>
              <div style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.8rem', fontWeight: 900, color: '#e85d04', marginBottom: '4px' }}>Bistro Montréal</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '32px' }}>
            {AMOUNTS.map(amount => (
              <div
                ...
                style={{
                  padding: '20px',
                  border: amount === 100 ? '2px solid #1a1a1a' : '1.5px solid #e8e0d5',
                  background: amount === 100 ? '#1a1a1a' : 'transparent',
                  textAlign: 'center',
                  cursor: 'pointer',
                  borderRadius: '4px',
              ...
              >
                <div style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.6rem', fontWeight: 700, color: amount === 100 ? '#e85d04' : '#1a1a1a' }}>${amount}</div>
          ...
          <div style={{ marginBottom: '40px' }}>
            ...
            <div style={{ display: 'flex', gap: '0' }}>
              <span style={{ padding: '14px 16px', background: '#f9f5f0', border: '1.5px solid #e8e0d5', borderRight: 'none', fontSize: '16px', color: '#888', fontWeight: 700 }}>$</span>
              <input
                type="number"
                min="25"
                placeholder="Enter amount (min $25)"
                style={{ flex: 1, padding: '14px 16px', border: '1.5px solid #e8e0d5', fontSize: '16px', color: '#1a1a1a', background: '#fff', outline: 'none', fontFamily: "'DM Sans', sans-serif" }}
              />
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '24px' }}>
            {[['Recipient name', 'text'], ['Recipient email', 'email']].map(([label, type]) => (
              <div key={label}>
                ...
                <input type={type} style={{ width: '100%', padding: '0 0 12px', border: 'none', borderBottom: '1.5px solid #e8e0d5', fontSize: '15px', color: '#1a1a1a', background: 'transparent', outline: 'none', fontFamily: "'DM Sans', sans-serif" }} />
              </div>
            ))}
          </div>
          <div style={{ marginBottom: '40px' }}>
